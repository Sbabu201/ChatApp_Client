...
const SideBar = () => {
    ...
    return (
        ...
        <div className='w-[20%] fixed z-10 text-lg cursor-pointer font-times  bg-black border-r-2 border-gray-600 flex flex-col justify-start items-start md:p-10 gap-10 text-white  min-h-screen'>

            <span className=' font-extrabold text-violet-500 px-4  '>
                SOUMYAGRAM
            </span>

            <div className='flex w-full items-center  h-full'>
                <div className='flex gap-10  flex-col text-purple-500  w-full min-h-screen'>
                    ...
                    <div onClick={() => navigate("/modal")} className='flex gap-6 items-center font-bold shadow-md hover:bg-slate-600 rounded-sm  duration-300 p-1'>
                        <FcPlus size={32} />
                        <p>Create</p>
                    </div>
